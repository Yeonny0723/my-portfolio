...
<!-- ========================= SECTION  ========================= -->
<section class="section-name py-5">
<div class="container w-75">
<h2 class="w-100 text-center py-5">PCKD FAQ</h2>
  <p class="pb-3"><i>
	If you're new to PCKD or looking to better save your space, this guide will help you learn more about this platform and its features. 
  </i></p>
  <main>
    <div class="container">
      <details class="faq-card">
        <summary>Can I cancel/return orders at any time? <span class="faq-open-icon">+</span></summary>
      ...
      <details class="faq-card">
        <summary>We want to collaborate with you. How can we get in touch with you? <span class="faq-open-icon">+</span></summary>
        <span class="faq-card-spoiler">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ornare, sem at dictum faucibus, neque nunc pellentesque sem, nec pellentesque tellus ex vel lorem. Vestibulum magna odio, ornare in faucibus.</span>
      </details>
      <details class="faq-card">
        <summary>I'm not satisfied with my purchase. Can we get a refund? <span class="faq-open-icon">+</span></summary>
        <span class="faq-card-spoiler">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ornare, sem at dictum faucibus, neque nunc pellentesque sem, nec pellentesque tellus ex vel lorem. Vestibulum magna odio, ornare in faucibus.</span>
      </details>
      <details class="faq-card">
      ...
      <h4 class='w-100 text-center mt-5'>Still have questions?</h4>
      <p class="faq-aftertext">If you cannot find answer to your question in our FAQ, you can always<br>
        contact us. We will answer shortly!:<br> <i><b>info@pckd.com</b></i>
      </p>
    </div>
  </main>
</div><!-- container // -->
