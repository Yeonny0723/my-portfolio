...
<div class="container">
	<h2 class="title-page"><i>OUTERWEAR</i></h2>
...
<header class="border-bottom mb-4 pb-3">
		<div class="form-inline">
			<span class="mr-md-auto">10 Items </span>
...
<div class="row">
		...
		<figure class="card card-product-grid">
			...
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail_2.php" class="title">Long Puffer Jacket</a>
					<div class="price-wrap mt-2">
						<span class="price">$150</span>
						<del class="price-old">$530</del>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PUFFER2model.png">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/WINDBREAKER1model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Windbreaker(Blue)</a>
					<div class="price-wrap mt-2">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/WINDBREAKER2model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Windbreaker (Grey)</a>
					<div class="price-wrap mt-2">
						<span class="price">$60</span>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PUFFER4model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Puffer Jacket (Cloud)</a>
					<div class="price-wrap mt-2">
						<span class="price">$120</span>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/WINDBREAKER4model.png">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PUFFER5model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Puffer Jacket (Caramel)</a>
					<div class="price-wrap mt-2">
						<span class="price">$120</span>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/WINDBREAKER5model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Windbreaker (Caramel)</a>
					<div class="price-wrap mt-2">
						<span class="price">$60</span>
					</div> <!-- price-wrap.// -->
				</div>
