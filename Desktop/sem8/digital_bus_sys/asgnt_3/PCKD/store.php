...
<div class="container">
	...
	<h2 class="title-page"><i>COLLECTIONS</i></h2>
	...
	<article class="filter-group">
		...
		<div class="filter-content collapse show" id="collapse_1" style="">
			<div class="card-body">
				...
				<ul class="list-menu">
				<li><a href="featured.php">Featured Collection</a></li>
				<li><a href="special.php">Special Collaboration</a></li>
...
<header class="border-bottom mb-1 pb-0">
...
<div class="row">
	<div class="col-md-3">
		<div class="card card-product-grid">
			...
			<figcaption class="info-wrap">
				<a href="./product-detail.php" class="title">PCKD.xArtist</a>
	...
	<div class="col-md-3">
		<div class="card card-product-grid">
			...
			<figcaption class="info-wrap">
				<a href="./product-detail.php" class="title">PCKD.xLocalArtist</a>
	...
	<div class="col-md-3">
		<div class="card card-product-grid">
			<a href="./product-detail.php" class="img-wrap"> <img src="images/products/PUFFER4model.png" alt="puffer"> </a>
			<figcaption class="info-wrap">
				<a href="./product-detail.php" class="title">PCKD.xLocalArtist</a>
	...
	<div class="col-md-3">
		<div class="card card-product-grid">
			<a href="./product-detail.php" class="img-wrap"> <img src="images/products/TSHIRT3-model.png"> </a>
			<figcaption class="info-wrap">
				<a href="./product-detail.php" class="title">PCKD.xArtist</a>
				<div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
			</figcaption>
	...
	<header class="border-bottom mb-1 pb-3">
		<div class="form-inline">
...
<div class="row">
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PUFFER3model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" alt="puffer, jacket" class="title">Long Puffer Jacket</a>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				...
				<img src="images/products/TSHIRT3-model.png">
			...
			<figcaption class="info-wrap">
				...
				<a href="cart.php" class="btn btn-block btn-success">Added to cart </a>
			</figcaption>
		</figure>
	</div> <!-- col.// -->
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/TSHIRT2-model.png">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			...
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" alt="sleeves, tops" class="title">Round Neck Long Sleeves</a>
					<div class="price-wrap mt-2">
						<span class="price">$40</span>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PANTS1-model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" alt="wide, pants, men, women" class="title">Wide Fit Pants</a>
					<div class="price-wrap mt-2">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PANTS2-model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Fitted Ankle Pants</a>
					<div class="price-wrap mt-2">
						<span class="price">$50</span>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PANTS3-model.png">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PANTS4-model.png">
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			<div class="img-wrap"> 
				<img src="images/products/PANTS5-model.png">
				
			</div> <!-- img-wrap.// -->
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.php" class="title">Straight Ankle Pants</a>
					<div class="price-wrap mt-2">
						<span class="price">$55</span>
					</div> <!-- price-wrap.// -->
				</div>
