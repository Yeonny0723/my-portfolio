...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	   <a href="#"><img src="./images/products/PUFFER1model.png"></a>
	</div> <!-- img-big-wrap.// -->
...
<h2 class="item_name">PCKD X Collab Long Puffer Jacket</h2>

<div class="mb-3"> 
	<var class="item_price h4">$150.00</var>
	<del class="price-old">$540</del>
</div> 

<p>Designed by Collab, the PCKD X Collab Long Puffer Jacket excites a long and extremly warm outerwear which can be folded into a small pouch for versatility. The Collab has taken his time to design and refine the details of this puffer jacket by adding his logo to the back of the puffer jacket, which makes a large statement. </p>
...
<div class="row">
	...
	<article class="box mb-3">
		<div class="icontext w-100">
			<img src="./images/avatars/AVATAR2.png" class="img-xs icon rounded-circle">
			<div class="text">
				<span class="date text-muted float-md-right">11.05.2022 </span>  
				<h6 class="mb-1">Robert Right </h6>
				
			</div>
		</div> <!-- icontext.// -->
		<div class="mt-3">
			<p>
				This puffer collab between PCKD and Collab is absolutely wonderful and i have enjoyed using it over the past week, super comfortable and warm and definately portable. When I need it, I can literally pull it out of my backpack. It literally packs into a size of a sandwich!
			</p>	
		</div>
	</article>
