...
const SelfIntro = () => {
    ...
    return (
        <IntroDivStyle>
            ...
            <div>
                <ResumeButtonStyle target="_blank" href="https://graceful-canary-e9f.notion.site/Yeonny-who-focus-on-which-value-which-I-can-deliver-61b246d9cd5341d692ba3d6443330720"><i className="fa-regular fa-file fa-lg"></i>&nbsp;Resume (eng)</ResumeButtonStyle>
